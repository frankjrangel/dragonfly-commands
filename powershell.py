...
bash_rule = MappingRule(
    ...
    mapping = {
        ...
        "laradock bash": Text("docker-compose --user=laradock workspace bash") + Key("enter"),
        ...
        # Laradock
        "compile assets": Text("npm run dev"),
        "compile assets for production": Text("npm run production"),

        # Artisan
        "artisan make": Text("php artisan make:"),
        "artisan make [<text>]": Text("php artisan make:%(text)s "),
    },
    extras = [
        Dictation("text"),
        IntegerRef("n", 1, 30)
